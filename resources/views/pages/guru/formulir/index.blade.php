            ...
            <div
                ...
                <div class="relative">
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Penilaian Kompetensi</h2>
                            <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">Aspek Pedagogik - Bagian 3
                            </p>
                        </div>
                    </div>
                    <div
            ...
            <div
                ...
                <div class="p-6">
                        ...
                        <div class="flex items-start space-x-4 mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2 leading-tight">
                                    Kemampuan mengelola pembelajaran yang mendidik
                                </h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Seberapa baik guru dalam merancang dan melaksanakan kegiatan pembelajaran yang
                                    efektif dan inspiratif?
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        <!-- Sangat Baik -->
                        <label
                            class="rating-option flex items-center space-x-4 p-4 rounded-xl border-2 border-gray-100 dark:border-gray-600 hover:border-bangala/30 dark:hover:border-goldspel/30 cursor-pointer transition-all duration-300 group">
                            <input type="radio" name="q1" value="4" class="custom-radio">
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-2">
                                    <span
                                        class="font-semibold text-gray-900 dark:text-white group-hover:text-bangala dark:group-hover:text-goldspel transition-colors">Sangat
                                        Baik</span>
                                    <div class="star-rating flex space-x-1">
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                    </div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    Menunjukkan keunggulan dalam semua aspek pembelajaran dengan inovasi yang inspiratif
                                </p>
                            </div>
                        </label>
                        ...
                        <label
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-2">
                                    <span
                                        class="font-semibold text-gray-900 dark:text-white group-hover:text-bangala dark:group-hover:text-goldspel transition-colors">Baik</span>
                                    <div class="star-rating flex space-x-1">
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="far fa-star text-gray-300 dark:text-gray-500 text-base"></i>
                                    </div>
                                </div>
                                <p class="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    Memenuhi standar yang diharapkan dengan konsistensi yang baik
                                </p>
                            </div>
                        </label>
                        ...
                        <label
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-2">
                                    <span
                                        class="font-semibold text-gray-900 dark:text-white group-hover:text-bangala dark:group-hover:text-goldspel transition-colors">Cukup</span>
                                    <div class="star-rating flex space-x-1">
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="far fa-star text-gray-300 dark:text-gray-500 text-base"></i>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    Memerlukan beberapa perbaikan untuk mencapai standar optimal
                                </p>
                            </div>
                        </label>
                        ...
                        <label
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-2">
                                    <span
                                        class="font-semibold text-gray-900 dark:text-white group-hover:text-bangala dark:group-hover:text-goldspel transition-colors">Kurang</span>
                                    <div class="star-rating flex space-x-1">
                                        <i class="fas fa-star text-goldspel text-base"></i>
                                        <i class="far fa-star text-gray-300 dark:text-gray-500 text-base"></i>
                                        <i class="far fa-star text-gray-300 dark:text-gray-500 text-base"></i>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    Memerlukan perbaikan menyeluruh dan bimbingan intensif
                                </p>
                            </div>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex items-center space-x-1">
                                    <div class="w-2 h-2 bg-goldspel rounded-full"></div>
                                    <span class="text-xs">Selesai</span>
                                </div>
                                <div class="flex items-center space-x-1">
                                    <div class="w-2 h-2 bg-white/50 rounded-full"></div>
                                    <span class="text-xs">Tersisa</span>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="flex space-x-1 justify-center">
                                <i class="fas fa-star text-goldspel text-sm"></i>
                                <i class="fas fa-star text-goldspel text-sm"></i>
                                <i class="fas fa-star text-goldspel text-sm"></i>
                                <i class="fas fa-star-half-alt text-goldspel text-sm"></i>
                            </div>
                        </div>
                    </div>
                </div>

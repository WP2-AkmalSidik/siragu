            ...
            <div
                ...
                <div class="relative">
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Penilaian Kesolehan</h2>
                            <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">Aspek Keagamaan</p>
                        </div>
                    </div>
                    <div

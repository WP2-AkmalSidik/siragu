...
<head>
    ...
    <title>SIRAGU - Daftar Guru</title>
    <style>
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 min-h-screen pb-16 font-sans">
    ...
    <nav
        ...
        <div class="flex justify-around max-w-2xl mx-auto">
            ...
            <a href="/list-guru" class="flex flex-col items-center text-bangala">
    ...
    <script>
        function navigateToAssessment(teacherId) {
            // Redirect to assessment page with teacher ID
            window.location.href = `/kepsek-pengisian?teacher_id=${teacherId}`;
        }
    </script>
</body>

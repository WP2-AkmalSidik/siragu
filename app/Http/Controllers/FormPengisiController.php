...
class FormPengisiController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            // Render view
            $data = [
                'view'       => view('pages.admin.pengisi.table', ['targets' => $paginated])->render(),
        ...
        return view('pages.admin.pengisi.index');
    }
    ...
    {
        return view('pages.admin.pengisi.tambah');
    }
